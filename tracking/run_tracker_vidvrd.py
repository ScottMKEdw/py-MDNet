...
def run_mdnet(img_list, init_bbox, gt=None, savefig_dir='', display=False):
    ...
    tic = time.time()
    # Load first image
    image = Image.open(os.path.join(r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\datasets\vid_VRD_Data\vidVRD_TestData\ILSVRC2015_train_00005003', img_list[0])).convert('RGB')
    ...
    for i in range(1, len(img_list)):
        ...
        print('Image :', i)
        #print(img_list)
        image = Image.open(os.path.join(r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\datasets\vid_VRD_Data\vidVRD_TestData\ILSVRC2015_train_00005003', img_list[i])).convert('RGB')
...
pickle = pandas.read_pickle(r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\datasets\vidVRD_Pickle.pkl', compression='infer')

img_list = (os.listdir(r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\datasets\vid_VRD_Data\vidVRD_TestData\ILSVRC2015_train_00005003'))

.sort(key=lambda f: int(''. join(filter(str. isdigit, f))))

print(img_list)
init_bbox = pickle['ILSVRC2015_train_00005003']['gt'][0]
gt = pickle['ILSVRC2015_train_00005003']['gt']
savefig_dir = r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\tracking\Test_Fig'
display = True
result_path = r'C:\Users\scott\Documents\School\GitHub\MDNet\py-MDNet\tracking\Test_Fig\Result'
